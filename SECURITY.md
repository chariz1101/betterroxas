...
We take security seriously at BetterRoxas. If you discover a security vulnerability, please report it responsibly.

### How to Report

**Do NOT open a public GitHub issue for security vulnerabilities.**

Instead, please email: **volunteer@betterroxas.org**
...
| Open-Meteo API   | Weather data     | Location (Roxas City)    |
...
For security concerns: **volunteer@betterroxas.org**

For general inquiries: Open a GitHub issue or join our [Discord](https://discord.com/invite/qeSu7RJkjQ)

---

Thank you for helping keep BetterRoxas secure for the community.
