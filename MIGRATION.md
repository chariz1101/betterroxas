...
This document provides guidance for contributors migrating from the static HTML version to the React + TypeScript version of BetterRoxas.

## Overview

BetterRoxas now has two versions:
