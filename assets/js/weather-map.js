/**
 * Weather & Map Section for Better Roxas Homepage
 * Displays real-time weather data and interactive map of Roxas City, Capiz
...
(function () {
  ...
  const WeatherService = {
    CACHE_KEY: 'roxas_weather_cache',
    CACHE_TTL: 30 * 60 * 1000,
    API_URL: 'https://api.open-meteo.com/v1/forecast',
    COORDINATES: { lat: 11.5894, lon: 122.7511 },
  ...
  const WeatherUI = {
    render(container, data) {
      ...
      try {
        ...
        container.innerHTML = `
                <div class="weather-widget" role="region" aria-label="Current weather in Roxas City">
                    <div class="weather-current">
                        ...
                        <div class="weather-current-info">
                            ...
                            <div class="weather-current-location">
                                <i class="bi bi-geo-alt" aria-hidden="true"></i> Roxas City, Capiz
                            </div>
                        </div>
                    </div>
  ...
  const MapComponent = {
    ...
    initLeaflet(container) {
      try {
        ...
        // Add marker
        const marker = L.marker(this.ROXAS_CENTER).addTo(this.map);
        marker.bindPopup('<strong>Roxas City Hall</strong><br>Capiz 5800');
