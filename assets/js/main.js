...
function showInstallBanner() {
  ...
  banner.innerHTML =
    ...
    '<span>Install BetterRoxas for quick access to services.</span>' +
    '</div>' +
    '<div class="pwa-install-actions">' +
    '<button class="pwa-install-btn" aria-label="Install BetterRoxas app">Install</button>' +
