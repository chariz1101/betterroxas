...
// Only numbers traceable to roxascity.gov.ph, plus the national emergency line.
// Keep in sync with the static hotline bar in the legacy pages.
const hotlines = [
  ...
  { icon: 'bi-shield-fill', label: 'CERT Mobile', number: '0917 306 6741', tel: '09173066741' },
  { icon: 'bi-building', label: 'City Hall', number: '(036) 6212-049', tel: '0366212049' },
];
