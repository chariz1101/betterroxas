      ...
      <div className="container">
        <div className="footer-main-new">
          <div className="footer-brand">
            <img
              src="/assets/images/logo/better-roxas-logo-white.svg"
              alt="Better Roxas logo"
            ...
            <div className="footer-social-new">
              ...
              <a
                href="https://www.linkedin.com/company/betterroxas/"
                className="footer-social-btn"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links-new">
              <li>
                <a href="https://quiz.betterroxas.org/" target="_blank" rel="noopener noreferrer">
                  {t('footer-roxas-quiz')}
                </a>
              </li>
              <li>
              ...
              <li>
                <a
                  href="https://roxascity.gov.ph/wp-content/uploads/2025/10/As-of-October-21-2025-2.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          <div className="footer-column">
            <div
              ...
              role="status"
              aria-label="Cost to the People of Roxas City: Zero Pesos"
            >
              {t('footer-cost')} <span className="footer-cost-value">₱0</span>
            </div>
            <a href="mailto:volunteer@betterroxas.org" className="footer-contribute">
              <i className="bi bi-envelope-heart"></i> {t('footer-volunteer')}
            </a>
            <a
              href="https://github.com/chariz1101/betterroxas"
