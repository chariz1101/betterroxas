...
FIXES_FIL = {
    ...
    "Go to the City Social Welfare and Development Office (CSWDO) with:":
        "Pumunta sa Opisina ng Kagalingang Panlipunan at Pagpapaunlad ng Lungsod (CSWDO) na may dalang:",
    ...
    "Get your copy of COM duly registered and signed by the Receiving Officer and CCR or any authorized signatory. Accomplish Client Feedback Form and drop at designated suggestion box.":
        "Kunin ang iyong kopya ng COM na wastong nairehistro at nilagdaan ng Receiving Officer at CCR o sinumang awtorisadong lumagda. Punan ang Client Feedback Form at ihulog sa itinalagang suggestion box.",
    ...
    "While volunteers make every effort to secure BetterRoxas from online threats and keep information accurate, no system can be guaranteed to be perfectly secure, error-free, or completely up-to-date at all times.":
        "Bagaman ang mga boluntaryo ay nagsusumikap na pangalagaan ang BetterRoxas mula sa mga online na banta at panatilihing tumpak ang impormasyon, walang sistema ang maaaring garantiyahan na perpektong ligtas, walang error, o ganap na napapanahon sa lahat ng oras.",
}
