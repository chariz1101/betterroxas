...
FIL2 = {
    ...
    "Processing of salaries, wages, and other compensation for city employees": "Pagproseso ng mga sahod, suweldo, at iba pang kabayaran para sa mga empleyado ng lungsod",
    ...
    "Registration of birth for children born in Roxas City, Capiz": "Pagpaparehistro ng kapanganakan para sa mga batang ipinanganak sa Roxas City, Capiz",
    "Registration of death for persons who died in Roxas City, Capiz": "Pagpaparehistro ng pagkamatay para sa mga taong namatay sa Roxas City, Capiz",
    ...
    "Certification that a person has no declared property in Roxas City.": "Sertipikasyon na ang isang tao ay walang idineklaang ari-arian sa Roxas City.",
    ...
    "Application for Marriage License duly signed by the couple and the CCR": "Aplikasyon para sa Lisensya sa Kasal na wastong nilagdaan ng mag-asawa at ng CCR",
    ...
    "For engaged couples intending to get married in Roxas City": "Para sa mga magkasintahang nagbabalak magpakasal sa Roxas City",
    "After the PMC, go back to CCRO": "Pagkatapos ng PMC, bumalik sa CCRO",
    "CHO Certification of Cause of Death": "Sertipikasyon ng CHO ng Sanhi ng Pagkamatay",
    ...
    "Get your copy of COM duly registered and signed by the Receiving Officer and CCR or any authorized staff": "Kunin ang iyong kopya ng COM na wastong nairehistro at nilagdaan ng Receiving Officer at CCR o sinumang awtorisadong kawani",
...
FIL3 = {
    # Business/Permits
    "Application for new business permit for businesses operating in Roxas City": "Aplikasyon para sa bagong permiso sa negosyo para sa mga negosyong nag-ooperate sa Roxas City",
    ...
    "What do I need to start a new business in Roxas City?": "Ano ang kailangan ko upang magsimula ng bagong negosyo sa Roxas City?",
    ...
    "Tax declaration form for real property assessment in Roxas City, Capiz": "Form ng tax declaration para sa pagtatasa ng tunay na ari-arian sa Roxas City, Capiz",
    ...
    "Visit the City Treasurer's Office at the City Hall with your Tax Declaration or latest Official Receipt": "Bumisita sa Opisina ng Ingat-Yaman ng Lungsod sa Lungsod na may iyong Tax Declaration o pinakabagong Opisyal na Resibo",
...
FIL4 = {
    ...
    "Approval and signing by CSWDO Head": "Pag-apruba at pagpirma ng Pinuno ng CSWDO",
    ...
    "Report/seek assistance at CSWDO": "Mag-ulat/humingi ng tulong sa CSWDO",
    ...
    "Proof of residence in Roxas City": "Patunay ng paninirahan sa Roxas City",
...
FIL5 = {
    ...
    "Farm registration, certifications, and agricultural programs for Roxas City farmers": "Pagpaparehistro ng bukid, mga sertipikasyon, at mga programang agrikultural para sa mga magsasaka ng Roxas City",
    ...
    "Slaughter permit from the City Agriculturist": "Permiso sa pagkatay mula sa City Agriculturist",
    ...
    "Support programs for corn farmers in Roxas City": "Mga programa ng suporta para sa mga magsasaka ng mais sa Roxas City",
    ...
    "Carabao slaughter requires special permit from City Agriculturist": "Ang pagkatay ng kalabaw ay nangangailangan ng espesyal na permiso mula sa City Agriculturist",
...
FIL6 = {
    ...
    "Construction and agricultural equipment for city projects": "Mga kagamitan sa konstruksyon at agrikultura para sa mga proyekto ng lungsod",
    "Equipment rental is subject to availability and approval. Priority is given to city projects and emergency situations": "Ang pag-upa ng kagamitan ay depende sa pagkakaroon at pag-apruba. Ang prayoridad ay ibinibigay sa mga proyekto ng lungsod at mga sitwasyon ng emergency",
    "Management and maintenance of city vehicles and heavy equipment": "Pamamahala at pagpapanatili ng mga sasakyan at mabibigat na kagamitan ng lungsod",
    ...
    "Management and monitoring of city utility accounts including electricity, water, and telephone": "Pamamahala at pagsubaybay ng mga account ng utilidad ng lungsod kabilang ang kuryente, tubig, at telepono",
    ...
    "Procurement and distribution of common-use supplies and materials for city offices": "Pagkuha at pamamahagi ng mga karaniwang suplay at materyales para sa mga opisina ng lungsod",
    ...
    "The GSO assists in the procurement process for city supplies, equipment, and services in accordance with RA 9184": "Ang GSO ay tumutulong sa proseso ng pagkuha para sa mga suplay, kagamitan, at serbisyo ng lungsod alinsunod sa RA 9184",
    "The City General Services Office takes custody of all properties, real or personal, owned by the city": "Ang Opisina ng Pangkalahatang Serbisyo ng Lungsod ay nag-iingat ng lahat ng ari-arian, tunay o personal, na pagmamay-ari ng lungsod",
    ...
    "City ordinances enacted by the Sangguniang Panlungsod — local laws that govern the city": "Mga ordinansa ng lungsod na naipatupad ng Sangguniang Panlungsod — mga lokal na batas na namamahala sa lungsod",
    "Ordinance takes effect and is enforced within the city": "Ang ordinansa ay nagkakabisa at ipinapatupad sa loob ng lungsod",
    ...
    "Submit transmittal letter and franchise applications to the SP": "Isumite ang transmittal letter at mga aplikasyon ng prangkisa sa SP",
    "Third and Final Reading": "Ikatlo at Huling Pagbasa",
    "View All Ordinances on SP Website": "Tingnan ang Lahat ng Ordinansa sa Website ng SP",
    "View All Resolutions on SP Website": "Tingnan ang Lahat ng Resolusyon sa Website ng SP",
    ...
    "The City Budget Office assists barangays in the preparation of their Annual Budget. It conducts review and evaluation": "Ang Opisina ng Badyet ng Lungsod ay tumutulong sa mga barangay sa paghahanda ng kanilang Taunang Badyet. Nagsasagawa ito ng pagsusuri at ebalwasyon",
    "The City Budget Office processes disbursement vouchers particularly the integral part of Obligation Request": "Ang Opisina ng Badyet ng Lungsod ay nagpoproseso ng mga disbursement voucher lalo na ang mahalagang bahagi ng Obligation Request",
    "The City Accounting Office pre-audits disbursement vouchers to ensure compliance with accounting rules": "Ang Opisina ng Accounting ng Lungsod ay nag-pre-audit ng mga disbursement voucher upang matiyak ang pagsunod sa mga patakaran ng accounting",
...
FIL7 = {
    # Privacy Policy
    "This Privacy Policy explains how BetterRoxas collects, uses, and protects your information": "Ang Patakaran sa Privacy na ito ay nagpapaliwanag kung paano kinokolekta, ginagamit, at pinoprotektahan ng BetterRoxas ang iyong impormasyon",
    ...
    "These Terms of Use govern your access to and use of the BetterRoxas website": "Ang mga Tuntunin ng Paggamit na ito ay namamahala sa iyong pag-access at paggamit ng website ng BetterRoxas",
    ...
    "All content on this website is the property of BetterRoxas unless otherwise stated": "Ang lahat ng nilalaman sa website na ito ay pag-aari ng BetterRoxas maliban kung iba ang nakasaad",
    ...
    "Find answers to common questions about Roxas City services": "Maghanap ng mga sagot sa mga karaniwang tanong tungkol sa mga serbisyo ng lungsod ng Roxas City",
    "Is this website mobile-friendly?": "Ang website ba na ito ay mobile-friendly?",
    "Who developed Better Roxas?": "Sino ang gumawa ng Better Roxas?",
    ...
    "How do I contact the city government?": "Paano ako makikipag-ugnayan sa pamahalaang panlungsod?",
    "What services are available online?": "Anong mga serbisyo ang magagamit online?",
    "Where is the City Hall located?": "Nasaan ang Lungsod?",
    ...
    # Statistics
    "City Statistics": "Estadistika ng Lungsod",
    "Data and statistics about Roxas City, Capiz": "Datos at estadistika tungkol sa Roxas City, Capiz",
    ...
    "DPWH Infrastructure Projects in Roxas City": "Mga Proyekto ng Imprastraktura ng DPWH sa Roxas City",

    # Home page
    "Welcome to Better Roxas": "Maligayang Pagdating sa Better Roxas",
    "Your gateway to Roxas City services and information": "Ang iyong daan patungo sa mga serbisyo at impormasyon ng lungsod ng Roxas City",
    "Fetching news and updates from Roxas City.": "Kinukuha ang mga balita at update mula sa Roxas City.",
    "Fetching the latest news from Roxas City.": "Kinukuha ang pinakabagong balita mula sa Roxas City.",
    "Stay informed about the latest happenings in Roxas City": "Manatiling may kaalaman tungkol sa mga pinakabagong pangyayari sa Roxas City",
    ...
    # Contact
    "Contact the City Government": "Makipag-ugnayan sa Pamahalaang Panlungsod",
    "Get in touch with the city government of Roxas City": "Makipag-ugnayan sa pamahalaang panlungsod ng Roxas City",
    "Office Hours": "Oras ng Opisina",
    "City Hall Address": "Adres ng Lungsod",
...
KEEP_AS_IS = {
    'BLGF Portal', 'CMCI DTI Portal', 'LGU Roxas City Facebook',
    'PhilHealth', 'GSIS', 'SSS', 'Pag-IBIG', 'BFP', 'PNP', 'DILG',
    'CDRRMO', 'CSWDO', 'SEEDO', 'CPDO', 'BIR', 'DTI', 'SEC', 'DENR',
    'DPWH', 'DSWD', 'PSA', 'NBI', 'COA', 'CSC', 'DBM', 'DOH',
    'MTOF', 'BPLS', 'RPT', 'CTC', 'RPTA', 'Filipizen',
    'BetterRoxas', 'Better Roxas', 'Abakada.org',
    'Sangguniang Panlungsod', 'Sangguniang Panlalawigan',
    'Capiz', 'Roxas City', 'Bayombong', 'Facebook', 'Google',
}
