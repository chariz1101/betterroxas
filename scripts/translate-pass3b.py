...
PHRASES_FIL = {
    ...
    "Better Roxas is committed to ensuring digital accessibility for people with disabilities": "Ang Better Roxas ay nakatuon sa pagtiyak ng digital na accessibility para sa mga taong may kapansanan",
    "Better Roxas is committed to ensuring that our digital services are accessible to all citizens, regardless of ability": "Ang Better Roxas ay nakatuon sa pagtiyak na ang aming mga digital na serbisyo ay naa-access ng lahat ng mamamayan, anuman ang kakayahan",
    ...
    "BetterRoxas is a civic platform dedicated to empowering the people of Roxas City by providing transparent access to": "Ang BetterRoxas ay isang civic platform na nakatuon sa pagbibigay-kapangyarihan sa mga tao ng Roxas City sa pamamagitan ng pagbibigay ng transparent na access sa",
    "BetterRoxas is a general audience website providing civic information": "Ang BetterRoxas ay isang website para sa pangkalahatang madla na nagbibigay ng civic na impormasyon",
    "BetterRoxas provides public domain information to support civic engagement, transparency, and informed participation": "Ang BetterRoxas ay nagbibigay ng impormasyon sa public domain upang suportahan ang civic engagement, transparency, at may kaalamang pakikilahok",
    "BetterRoxas values accuracy, public safety, and respect for rights": "Pinahahalagahan ng BetterRoxas ang katumpakan, kaligtasan ng publiko, at paggalang sa mga karapatan",
    ...
    "BetterRoxas cannot guarantee that the website will be": "Hindi magagarantiya ng BetterRoxas na ang website ay magiging",
    ...
    "Official LGU Roxas City Portal": "Opisyal na Portal ng LGU Roxas City",
    "City Hall": "Lungsod",
    "City Mayor": "Punong Bayan",
    "City Accounting Office": "Opisina ng Accounting ng Lungsod",
    "City Budget Office": "Opisina ng Badyet ng Lungsod",
    "City Engineering Office": "Opisina ng Inhinyeriya ng Lungsod",
    "City General Services Office": "Opisina ng Pangkalahatang Serbisyo ng Lungsod",
    "City Treasurer's Office": "Opisina ng Ingat-Yaman ng Lungsod",
    "City Assessor's Office": "Opisina ng Tagapagtasa ng Lungsod",
    "City Planning and Development Office": "Opisina ng Pagpaplano at Pagpapaunlad ng Lungsod",
    "City Agriculture Office": "Opisina ng Agrikultura ng Lungsod",
    "City Health Office": "Opisina ng Kalusugan ng Lungsod",
