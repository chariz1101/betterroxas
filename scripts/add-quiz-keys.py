#!/usr/bin/env python3
"""
Add missing Roxas City Quiz and Quiz CTA translation keys to translations.js.
"""
...
# All the page-prefix variants for "Roxas City Quiz" footer link
prefixes = [
...
quiz_cta_en = {
    'home-roxas-quiz': 'Roxas City Quiz',
    'home-how-well-do-you-know-roxas-capiz': 'How well do you know Roxas City, Capiz?',
    'home-evaluate-your-familiarity-with-the-municipalitys': "Evaluate your familiarity with the city's heritage, cultural identity, and geographic significance through an interactive knowledge assessment designed to showcase one of Capiz's most prominent localities.",
    'home-take-the-quiz': 'Take the Quiz',
}

quiz_cta_fil = {
    'home-roxas-quiz': 'Roxas City Quiz',
    'home-how-well-do-you-know-roxas-capiz': 'Gaano mo kakilala ang Roxas City, Capiz?',
    'home-evaluate-your-familiarity-with-the-municipalitys': "Suriin ang iyong kaalaman sa pamana, pagkakakilanlan sa kultura, at kahalagahang heograpiko ng lungsod sa pamamagitan ng isang interactive na pagtatasa ng kaalaman na idinisenyo upang ipakita ang isa sa mga pinakatanyag na lokalidad ng Capiz.",
    'home-take-the-quiz': 'Subukin ang Quiz',
}

quiz_cta_ilo = {
    'home-roxas-quiz': 'Roxas City Quiz',
    'home-how-well-do-you-know-roxas-capiz': 'Kasano ti pannakaammom iti Roxas City, Capiz?',
    'home-evaluate-your-familiarity-with-the-municipalitys': "Evaluaren ti pannakaammom iti tawid, kultural a pagbigbigan, ken heograpiko a kapatgan ti lungsod babaen ti maysa nga interactive a panagsubok ti pannakaammo a naidisinio tapno ipakita ti maysa kadagiti kalatakan a lokalidad ti Capiz.",
...
def build_entries(lang):
    ...
    # Page-prefix Roxas City Quiz keys
    for prefix in prefixes:
        key = f'{prefix}-roxas-quiz'
        # "Roxas City Quiz" stays the same in all languages (it's a proper name)
        entries.append(f'        "{key}": "Roxas City Quiz"')
    
    # Quiz CTA keys
    if lang == 'en':
        for k, v in quiz_cta_en.items():
            # Skip home-roxas-quiz since it's already in the prefix list
            if k == 'home-roxas-quiz':
                continue
...
for k in ['home-take-the-quiz', 'home-how-well-do-you-know-roxas-capiz']:
